...
//    EDDTableFromDapSequence.testGenerateDatasetsXml2(); //requires testNccsvScalar in localhost ERDDAP
...
//        "g:/",
//        ".*\\.xml", false, ".*", true).dataToString(); //fileRegex, recursive, pathRegex, doAll (or just 1)
