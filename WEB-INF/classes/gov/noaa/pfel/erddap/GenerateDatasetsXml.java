      ...
      do {
        try {
          ...
          switch (eddType) {
            ...
            case "EDDGridFromThreddsCatalog" -> {
            ...
            case "EDDGridLonPM180FromErddapCatalog" -> {
            ...
            case "EDDGridLon0360FromErddapCatalog" -> {
              s1 = get(args, 1, s1, "ERDDAP URL (ending in \"/erddap/\")");
              s2 = get(args, 2, s2, "Dataset name regex (usually \".*\")");
              String2.log("working...");
            ...
            case "EDDTableFromInPort" -> {
              ...
              s2 =
                  get(
                      ...
                      2,
                      s2,
                      "Directory in which to store the InPort xml file (if URL above)");
