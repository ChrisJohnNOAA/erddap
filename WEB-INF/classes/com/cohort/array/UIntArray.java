...
public class UIntArray extends PrimitiveArray {
  ...
  public int getArrayVal(final int i) {
    return array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i);
  }
  public void setArrayVal(final int i, final int val) {
    array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i, val);
  }
  ...
  public PrimitiveArray makeSignedPA() {
    ...
    if (wrappedArray != null) {
      ...
      java.lang.foreign.MemorySegment.copy(array, (0) * 4L, java.lang.foreign.MemorySegment.ofArray(ar), (0) * 4L, (size) * 4L);
    }
  ...
  public PrimitiveArray subset(
    ...
    if (stopIndex < startIndex) return pa == null ? new UIntArray(new int[0]) : pa;

    int willFind = strideWillFind(stopIndex - startIndex + 1, stride);
    UIntArray da = null;
    if (pa == null) {
      da = new UIntArray(willFind, true);
    } else {
      da = (UIntArray) pa;
  ...
  public void addN(final int n, final long value) {
    ...
    if (wrappedArray != null) {
      ...
      for (int i = size; i < size + n; i++) {
        array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i, pack(value));
      }
    }
    size += n;
  }
  ...
  public PrimitiveArray addFromPA(final PrimitiveArray otherPA, int otherIndex, final int nValues) {
    ...
    if (otherPA.elementType() == elementType()) {
      ...
      {
          UIntArray oPA = (UIntArray) ((UIntArray) otherPA);
  ...
  public int[] toArray() {
    ...
    return array.asSlice(0, size * 4L).toArray(java.lang.foreign.ValueLayout.JAVA_INT);
  }
  ...
  public String[] toStringArray() {
    ...
    for (int i = 0; i < size; i++) {
      final long j = unpack(getArrayVal(i));
  ...
  public String toNccsvAttString() {
    ...
    for (int i = 0; i < size; i++) sb.append((i == 0 ? "" : ",") + unpack(getArrayVal(i)) + "ui");
    return sb.toString();
  }
  ...
  public void sort() {
    ...
    if (size < 8192) if (wrappedArray != null) {
      ...
      int[] temp = array.asSlice(0, size * 4L).toArray(java.lang.foreign.ValueLayout.JAVA_INT);
  ...
  public void reverseBytes() {
    for (int i = 0; i < size; i++) {
      int val = array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i);
      array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i, Integer.reverseBytes(val));
    }
  }
  ...
  public void readDis(final DataInputStream dis, final int n) throws Exception {
    ensureCapacity(size + (long) n);
    for (int i = 0; i < n; i++) setArrayVal(size++, dis.readInt());
  }
  ...
  public void internalizeFromDODS(final DataInputStream dis) throws java.io.IOException {
    ...
    for (int i = 0; i < nValues; i++) setArrayVal(size++, dis.readInt());
  }
  ...
  public void writeToRAF(final RandomAccessFile raf, final int index) throws Exception {
    raf.writeInt(getArrayVal(index));
  }
  ...
  public void rawAppend(final PrimitiveArray pa) {
    ...
    if (pa instanceof UIntArray ua) {
      ...
      for (int i = 0; i < otherSize; i++)
        setArrayVal(size + i, pack(Math2.roundToUInt(pa.getRawDouble(i)))); // this DOESN'T convert mv's
    }
  ...
  public PrimitiveArray makeIndices(final IntArray indices) {
    ...
    long lastValue = unpack(getArrayVal(0)); // since lastValue often equals currentValue, cache it
    hashMap.put(lastValue, dummy);
    boolean alreadySorted = true;
    for (int i = 1; i < size; i++) {
      long currentValue = unpack(getArrayVal(i));
  ...
  public void changeSignedToFromUnsigned() {
    for (int i = 0; i < size; i++) {
      ...
      setArrayVal(i, (int) (i2 < 0 ? i2 + MAX_VALUE + 1 : i2 - MAX_VALUE - 1)); // order of ops is important
    }
  }
}
