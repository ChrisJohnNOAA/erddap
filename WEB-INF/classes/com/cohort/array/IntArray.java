...
public class IntArray extends PrimitiveArray {
  ...
  public PrimitiveArray subset(
    ...
    if (stopIndex < startIndex) return pa == null ? new IntArray(new int[0]) : pa;

    int willFind = strideWillFind(stopIndex - startIndex + 1, stride);
    IntArray da = null;
    if (pa == null) {
      da = new IntArray(willFind, true);
    } else {
      da = (IntArray) pa;
  ...
  public final void addN(final int n, final int value) {
    ...
    if (wrappedArray != null) {
      ...
      for (int i = size; i < size + n; i++) {
        array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, i, value);
      }
    }
    size += n;
  }
  ...
  public PrimitiveArray addFromPA(final PrimitiveArray otherPA, int otherIndex, final int nValues) {
    ...
    if (otherPA.elementType() == elementType()) {
      ...
      {
          IntArray oPA = (IntArray) ((IntArray) otherPA);
  ...
  public int get(final int index) {
    ...
    return array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, index);
  }
  ...
  public void set(final int index, final int value) {
    ...
    array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_INT, index, value);
  }
  ...
  public void rawAppend(final PrimitiveArray pa) {
    ...
    if (pa instanceof IntArray ia) {
      ...
      for (int i = 0; i < otherSize; i++)
        setArrayVal(size + i, pa.getRawInt(i)); // this DOESN'T convert mv's
    }
