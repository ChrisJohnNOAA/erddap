...
public class UShortArray extends PrimitiveArray {
  ...
  private short[] wrappedArray;

  public short getArrayVal(final int i) {
    return array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i);
  }
  public void setArrayVal(final int i, final short val) {
    array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i, val);
  }
  ...
  /**
   * A special method which encodes all char values as short values via <tt>sa.getArrayVal(i) =
   * (short)getArrayVal(i)</tt>. Thus negative short values become large positive char values. Note that
  ...
  public static UShortArray fromCharArrayBytes(final CharArray ca) {
    ...
    for (int i = 0; i < size; i++) sarray[i] = (short) ca.getArrayVal(i);
    java.lang.foreign.MemorySegment.copy(java.lang.foreign.MemorySegment.ofArray(sarray), 0, sa.array, 0, size * 2L);
    return sa;
  }
  ...
  public PrimitiveArray makeSignedPA() {
    ...
    if (wrappedArray != null) {
      ...
      java.lang.foreign.MemorySegment.copy(array, (0) * 2L, java.lang.foreign.MemorySegment.ofArray(ar), (0) * 2L, (size) * 2L);
    }
  ...
  public PrimitiveArray subset(
    ...
    if (stopIndex < startIndex) return pa == null ? new UShortArray(new short[0]) : pa;

    int willFind = strideWillFind(stopIndex - startIndex + 1, stride);
    UShortArray da = null;
    if (pa == null) {
      da = new UShortArray(willFind, true);
    } else {
      da = (UShortArray) pa;
    ...
    if (stride == 1) {
      if (wrappedArray != null && da.wrappedArray != null) {
        ...
        java.lang.foreign.MemorySegment.copy(array, startIndex * 2L, da.array, 0, willFind * 2L);
      }
    } else {
      int po = 0;
  ...
  public void addN(final int n, final int value) {
    ...
    if (wrappedArray != null) {
      Arrays.fill(wrappedArray, size, size + n, pack(value));
    } else {
      for (int i = size; i < size + n; i++) {
        array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i, pack(value));
      }
    }
    size += n;
  }
  ...
  public PrimitiveArray addFromPA(final PrimitiveArray otherPA, int otherIndex, final int nValues) {
    ...
    if (otherPA.elementType() == elementType()) {
      ...
      {
          UShortArray oPA = (UShortArray) ((UShortArray) otherPA);
          if (wrappedArray != null && oPA.wrappedArray != null) {
            System.arraycopy(oPA.wrappedArray, otherIndex, wrappedArray, size, nValues);
          } else {
            java.lang.foreign.MemorySegment.copy(oPA.array, (otherIndex) * 2L, array, (size) * 2L, (nValues) * 2L);
          }
        }
      size += nValues;
  ...
  public void remove(final int index) {
    ...
    if (wrappedArray != null) {
      ...
      java.lang.foreign.MemorySegment.copy(array, (index + 1) * 2L, array, index * 2L, (size - index - 1) * 2L);
    }
    size--;
  }
  ...
  public void removeRange(final int from, final int to) {
    ...
    if (wrappedArray != null) {
      ...
      java.lang.foreign.MemorySegment.copy(array, to * 2L, array, from * 2L, (size - to) * 2L);
    }
    size -= to - from;
  }
  ...
  public short[] toArray() {
    ...
    return array.asSlice(0, size * 2L).toArray(java.lang.foreign.ValueLayout.JAVA_SHORT);
  }
  ...
  public double[] toDoubleArray() {
    ...
    for (int i = 0; i < size; i++) {
      final int s = unpack(getArrayVal(i));
  ...
  public String toString() {
    ...
    for (int i = 0; i < size; i++) {
      if (i > 0) sb.append(", ");
      sb.append(unpack(getArrayVal(i)));
    }
    return sb.toString();
  }
  ...
  public String toNccsvAttString() {
    ...
    for (int i = 0; i < size; i++) sb.append((i == 0 ? "" : ",") + unpack(getArrayVal(i)) + "us");
    return sb.toString();
  }
  ...
  public void sort() {
    ...
    if (size < 8192) if (wrappedArray != null) {
      Arrays.sort(wrappedArray, 0, size);
    } else {
      short[] temp = array.asSlice(0, size * 2L).toArray(java.lang.foreign.ValueLayout.JAVA_SHORT);
  ...
  public void reorder(final int rank[]) {
    ...
    long currentCapacity = array.byteSize() / 2;
    Math2.ensureMemoryAvailable(2L * currentCapacity, "UShortArray");
  ...
  public void reverseBytes() {
    for (int i = 0; i < size; i++) {
      short val = array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i);
      array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i, Short.reverseBytes(val));
    }
  }
  ...
  public void readDis(final DataInputStream dis, final int n) throws Exception {
    ensureCapacity(size + (long) n);
    for (int i = 0; i < n; i++) setArrayVal(size++, dis.readShort());
  }
  ...
  public void externalizeForDODS(final DataOutputStream dos) throws Exception {
    ...
    for (int i = 0; i < size; i++) dos.writeInt(getArrayVal(i)); // yes, as ints
  }
  ...
  public void externalizeForDODS(final DataOutputStream dos, final int i) throws Exception {
    dos.writeInt(getArrayVal(i)); // as if int
  }
  ...
  public void internalizeFromDODS(final DataInputStream dis) throws java.io.IOException {
    ...
    for (int i = 0; i < nValues; i++) setArrayVal(size++, (short) dis.readInt()); // yes, ints; see above
  }
  ...
  public void writeToRAF(final RandomAccessFile raf, final int index) throws Exception {
    raf.writeShort(getArrayVal(index));
  }
  ...
  public void append(final PrimitiveArray pa) {
    ...
    if (pa instanceof UShortArray ua) {
      ...
      {
          UShortArray oPA = (UShortArray) ua;
          if (wrappedArray != null && oPA.wrappedArray != null) {
            System.arraycopy(oPA.wrappedArray, 0, wrappedArray, size, otherSize);
          } else {
            java.lang.foreign.MemorySegment.copy(oPA.array, (0) * 2L, array, (size) * 2L, (otherSize) * 2L);
          }
        }
      size += otherSize;
    } else {
  ...
  public void rawAppend(final PrimitiveArray pa) {
    ...
    if (pa instanceof UShortArray ua) {
      ...
      for (int i = 0; i < otherSize; i++)
        setArrayVal(size + i, pack(Math2.narrowToUShort(pa.getRawInt(i)))); // this DOESN'T convert mv's
    }
  ...
  public PrimitiveArray makeIndices(final IntArray indices) {
    ...
    int lastValue = unpack(getArrayVal(0)); // since lastValue often equals currentValue, cache it
    hashMap.put(lastValue, dummy);
    boolean alreadySorted = true;
    for (int i = 1; i < size; i++) {
      int currentValue = unpack(getArrayVal(i));
    ...
    lastValue = unpack(getArrayVal(0));
    ...
    for (int i = 1; i < size; i++) {
      if (getArrayVal(i) == lastValue) {
        ...
        lastValue = unpack(getArrayVal(i));
  ...
  public int[] getNMinMaxIndex() {
    ...
    int tmax = MIN_VALUE;
    for (int i = 0; i < size; i++) {
      if (maxIsMV && getArrayVal(i) == PACKED_MAX_VALUE) {
      } else {
        int v = unpack(getArrayVal(i));
        n++;
        if (v <= tmin) {
          tmini = i;
          tmin = v;
  ...
  public void changeSignedToFromUnsigned() {
    for (int i = 0; i < size; i++) {
      ...
      setArrayVal(i, (short) (i2 < 0 ? i2 + MAX_VALUE + 1 : i2 - MAX_VALUE - 1)); // order of ops is important
    }
  }
}
