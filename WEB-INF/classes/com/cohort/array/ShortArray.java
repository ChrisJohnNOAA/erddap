...
public class ShortArray extends PrimitiveArray {
  ...
  public PrimitiveArray subset(
    ...
    if (stopIndex < startIndex) return pa == null ? new ShortArray(new short[0]) : pa;

    int willFind = strideWillFind(stopIndex - startIndex + 1, stride);
    ShortArray da = null;
    if (pa == null) {
      da = new ShortArray(willFind, true);
    } else {
      da = (ShortArray) pa;
  ...
  public void addN(final int n, final short value) {
    ...
    if (wrappedArray != null) {
      ...
      for (int i = size; i < size + n; i++) {
        array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, i, value);
      }
    }
    size += n;
  }
  ...
  public PrimitiveArray addFromPA(final PrimitiveArray otherPA, int otherIndex, final int nValues) {
    ...
    if (otherPA.elementType() == elementType()) {
      ...
      {
          ShortArray oPA = (ShortArray) ((ShortArray) otherPA);
  ...
  public short get(final int index) {
    ...
    return array.getAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, index);
  }
  ...
  public void set(final int index, final short value) {
    ...
    array.setAtIndex(java.lang.foreign.ValueLayout.JAVA_SHORT, index, value);
  }
  ...
  public void rawAppend(final PrimitiveArray pa) {
    ...
    if (pa instanceof ShortArray sa) {
      ...
      for (int i = 0; i < otherSize; i++)
        setArrayVal(size + i, Math2.narrowToShort(pa.getRawInt(i))); // this DOESN'T convert mv's
    }
