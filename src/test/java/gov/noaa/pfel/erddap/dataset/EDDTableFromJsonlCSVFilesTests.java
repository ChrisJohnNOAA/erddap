  ...
  void testSchema(boolean generateCroissantSchema) throws Throwable {
    ...
    expected =
        "{\n"
            ...
            + "    }\n"
            + "  ],\n"
            + "  \"description\": \"This is the sample summary.\\n"
            + "cdm_data_type=Trajectory\\n"
            + "cdm_trajectory_variables=ship\\n"
            + "Conventions=COARDS, CF-1.6, ACDD-1.3\\n"
            + "Easternmost_Easting=-130.2576\\n"
            + "featureType=Trajectory\\n"
            + "geospatial_lat_max=28.0003\\n"
            + "geospatial_lat_min=27.9998\\n"
            + "geospatial_lat_units=degrees_north\\n"
            + "geospatial_lon_max=-130.2576\\n"
            + "geospatial_lon_min=-132.0014\\n"
            + "geospatial_lon_units=degrees_east\\n"
            + "infoUrl=https://jsonlines.org/examples/\\n"
            + "institution=jsonlines.org\\n"
            + "Northernmost_Northing=28.0003\\n"
            + "sourceUrl=(local files)\\n"
            + "Southernmost_Northing=27.9998\\n"
            + "standard_name_vocabulary=CF Standard Name Table v70\\n"
            + "subsetVariables=ship\\n"
            + "time_coverage_end=2017-03-23T21:45:00Z\\n"
            + "time_coverage_start=2017-03-23T00:45:00Z\\n"
            + "Westernmost_Easting=-132.0014\",\n"
            + "  \"url\": \"http://localhost:8080/erddap/tabledap/testJsonlCSV.html\",\n"
            ...
            + "        }\n"
            + "      ],\n"
            + "      \"maxValue\": \"2017-03-23T21:45:00Z\",\n"
            + "      \"minValue\": \"2017-03-23T00:45:00Z\",\n"
            + "      \"propertyID\": \"time\"\n"
            + "    },\n"
            + "    {\n"
            + "      \"@type\": \"PropertyValue\",\n"
            ...
            + "        }\n"
            + "      ],\n"
            + "      \"maxValue\": 9.223372036854776E18,\n"
            + "      \"minValue\": -9.223372036854776E18\n"
            + "    },\n"
            + "    {\n"
            + "      \"@type\": \"PropertyValue\",\n"
            + "      \"name\": \"sst\",\n"
            ...
            + "    }\n"
            + "  ],\n"
            + "  \"identifier\": \"testJsonlCSV\",\n"
            + "  \"temporalCoverage\": \"2017-03-23T00:45:00Z/2017-03-23T21:45:00Z\",\n"
            + "  \"spatialCoverage\": {\n"
            + "    \"@type\": \"Place\",\n"
            + "    \"geo\": {\n"
            + "      \"@type\": \"GeoShape\",\n"
            + "      \"box\": \"27.9998 -132.0014 28.0003 -130.2576\"\n"
            + "    }\n"
            + "  }\n"
            + "}\n";
    tResults = results.substring(0, Math.min(results.length(), expected.length()));
