    ...
    if (edd == null) {
      throw new RuntimeException(
          "edd is null! results=\n"
              + results
              + "\nFailed datasets: "
              + EDStatic.failedDatasetsWithErrors);
    }
...
http://localhost:8080/erddap/files/awsS3NoaaGoes17/SUVI-L1b-He303/,,,NaN,
  ...
  void testSchema(boolean generateCroissantSchema) throws Throwable {
    ...
    EDDTable eddTable = (EDDTable) EDDTestDataset.gettestFileNames();
    tName =
    ...
    expected =
        "{\n"
            ...
            + "        }\n"
            + "      ],\n"
            + "      \"maxValue\": \"2015-01-05T09:00:00Z\",\n"
            + "      \"minValue\": \"2015-01-03T09:00:00Z\",\n"
            + "      \"propertyID\": \"time\"\n"
            + "    },\n"
            + "    {\n"
            + "      \"@type\": \"PropertyValue\",\n"
            ...
            + "        }\n"
            + "      ],\n"
            + "      \"maxValue\": 1.72867911E9,\n"
            + "      \"minValue\": 1.72867911E9,\n"
            ...
            + "    }\n"
            + "  ],\n"
            + "  \"identifier\": \"testFileNames\",\n"
            + "  \"temporalCoverage\": \"2015-01-03T09:00:00Z/2015-01-05T09:00:00Z\",\n"
            + "  \"spatialCoverage\": {\n"
            + "    \"@type\": \"Place\",\n"
            + "    \"geo\": {\n"
            + "      \"@type\": \"GeoShape\",\n"
