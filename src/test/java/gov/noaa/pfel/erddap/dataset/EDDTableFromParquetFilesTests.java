...
class EDDTableFromParquetFilesTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String expected =
        "<!-- NOTE! Since Parquet files have no metadata, you MUST edit the chunk\n"
            ...
            + "        <att name=\"keywords\">amount, array, array-data, attribution, AttributionSources, class, comprehensive, context, data, flow, flowable, FlowAmount, FlowType, FlowUUID, large, local, Location, LocationSystem, meta, MetaSources, name, produced, sector, SectorProducedBy, SectorSourceName, source, SourceName, sources, stewardship, system, time, type, unit, uuid, year</att>\n"
            + "        <att name=\"license\">[standard]</att>\n"
            + "        <att name=\"sourceUrl\">(local files)</att>\n"
            + "        <att name=\"standard_name_vocabulary\">CF Standard Name Table v70</att>\n"
            + "        <att name=\"subsetVariables\">Class, SectorSourceName, Context, LocationSystem, FlowType, Year</att>\n"
  ...
  void testBasic(boolean deleteCachedDatasetInfo) throws Throwable {
    ...
    expected =
        "    String infoUrl \"???\";\n"
            + "    String institution \"???\";\n"
            + "    String keywords \"amount, array, array-data, attribution, AttributionSources, class, comprehensive, context, data, flow, flowable, FlowAmount, FlowType, FlowUUID, large, local, Location, LocationSystem, meta, MetaSources, name, produced, sector, SectorProducedBy, SectorSourceName, source, SourceName, sources, stewardship, system, time, type, unit, uuid, year\";\n"
            ...
            + "    String subsetVariables \"Class, SectorSourceName, Context, LocationSystem, FlowType, Year\";\n"
    ...
    // String2.log(results);
    expected =
        "Flowable,Class,SectorProducedBy,SectorSourceName,Context,Location,LocationSystem,FlowAmount,Unit,FlowType,Year,MetaSources,FlowUUID,AttributionSources\n"
            + ",,,,,,,,,,,,,\n"
