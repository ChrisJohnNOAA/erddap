...
public class WireMockStarter {
  ...
  public static synchronized void start() {
    ...
    stubFromResourceData(
        "/dods/public_data/SODA/soda_pop2.2.4.dods?time,lev,lat,lon", "/mock/apdrc/soda_pop2.2.4_axes.dods");
    stubFromResourceData(
        "/dods/public_data/SODA/soda_pop2.2.4.dods?time,lat,lon", "/mock/apdrc/soda_pop2.2.4_axes_3d.dods");
