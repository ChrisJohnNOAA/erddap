...
class UShortArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(UShortArray.pack(0), 0, "");
    Test.ensureEqual(UShortArray.pack(32767), 32767, "");
    Test.ensureEqual(UShortArray.pack(32768), -32768, "");
    Test.ensureEqual(UShortArray.pack(65534), -2, "");
    Test.ensureEqual(UShortArray.pack(65535), -1, "");

    Test.ensureEqual(UShortArray.unpack((short) 0), 0, "");
    Test.ensureEqual(UShortArray.unpack((short) 32767), 32767, "");
    Test.ensureEqual(UShortArray.unpack((short) -32768), 32768, "");
    Test.ensureEqual(UShortArray.unpack((short) -2), 65534, "");
    Test.ensureEqual(UShortArray.unpack((short) -1), 65535, "");
    ...
    Test.ensureEqual(anArray.missingValue().getRawDouble(), UShortArray.MAX_VALUE, "");
    anArray.addString("");
    Test.ensureEqual(anArray.get(0), UShortArray.MAX_VALUE, "");
    Test.ensureEqual(anArray.getRawInt(0), UShortArray.MAX_VALUE, "");
    Test.ensureEqual(anArray.getRawDouble(0), UShortArray.MAX_VALUE, "");
    Test.ensureEqual(anArray.getUnsignedDouble(0), Double.NaN, "");
    Test.ensureEqual(anArray.getRawString(0), "" + UShortArray.MAX_VALUE, "");
    Test.ensureEqual(anArray.getRawNiceDouble(0), UShortArray.MAX_VALUE, "");
    ...
    anArray.set(0, 32767);
    Test.ensureEqual(anArray.getUnsignedDouble(0), 32767, "");
    anArray.set(0, 32768);
    Test.ensureEqual(anArray.getUnsignedDouble(0), 32768, "");
    anArray.set(0, 65534);
    Test.ensureEqual(anArray.getUnsignedDouble(0), 65534, "");
    anArray.set(0, 65535);
    Test.ensureEqual(anArray.getUnsignedDouble(0), Double.NaN, "");
    anArray.clear();
    ...
    anArray.remove(5);
    Test.ensureEqual(stats[UShortArray.STATS_N], 5, "");
    Test.ensureEqual(stats[UShortArray.STATS_MIN], 0, "");
    Test.ensureEqual(stats[UShortArray.STATS_MAX], 8, "");
    Test.ensureEqual(stats[UShortArray.STATS_SUM], 20, "");
    ...
    anArray = new UShortArray(new int[] {35, 35, UShortArray.MAX_VALUE, 1, 2});
    ...
    anArray =
        new UShortArray(
            new int[] {
              UShortArray.MAX_VALUE, 1, 2, UShortArray.MAX_VALUE, 3, UShortArray.MAX_VALUE
            });
    ...
    anArray.set(2, UShortArray.MAX_VALUE);
    Test.ensureEqual(anArray.isAscending(), "", "");
    ...
    Test.ensureEqual(
        anArray.isAscending(), "UShortArray isn't sorted in ascending order: [0]=10 > [1]=9.", "");
    ...
    Test.ensureEqual(
        new UShortArray(new int[] {UShortArray.MAX_VALUE}).tryToFindNumericMissingValue(),
        UShortArray.MAX_VALUE,
        "");
